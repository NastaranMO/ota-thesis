        ...
        <div id="outerDiv">
            ...
            <div id="centerDiv">
                <div id="jQueryDiv">
                    ...
                    <div>
                        ...
                        <div style="margin-top: -170px; margin-right: 880px;">
                            <asp:ImageButton ID="nextButton" ImageUrl="~/images/1.png" runat="server" />
            ...
            <div id="bottomDiv">
                <div id="Right">
                    ...
                    <div class="content">
                        <div class="left">
                            <img src="images/manabe.gif" alt="منابع انسانی" />
                        </div>
                        <div>
                            شركت داروسازي الماس 
            ...
            <div id="contentDiv">
                <div style="float: left; width: 600px;">
                    ...
                    <div class="content">
                        ...
                        عرضه محصولات درمانی و بهداشتی روز دنیا اهتمام ورزیم.
                        </div>
                    </div>
                </div>
                <div id="login">
