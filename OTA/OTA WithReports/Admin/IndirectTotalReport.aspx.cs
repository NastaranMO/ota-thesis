...
public partial class Admin_Reports_IndirectTotalReport : System.Web.UI.Page
{
    ...
    protected void cvAdd_ServerValidate(object source, ServerValidateEventArgs args)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                {
                    sqlQuery = "Select * From rptInDirects Where  Tarikh >='" + startDate.ToShortDateString() + "' AND Tarikh <= '" + endDate.ToShortDateString() + "'";
                }
                else
                {
                    ...
                    sqlQuery = "Select * From rptInDirects Where  Tarikh >='" + startDate.ToShortDateString() + "' AND Tarikh <= '" + endDate.ToShortDateString() + "' AND DepName LIKE '" + depName + "'";
                ...
                string strPath = Server.MapPath(@"~\CrystalReports\InDirect_Tarikh.rpt");
