<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="code-gheyre-amaliat.aspx.cs" Inherits="Admin_code_gheyre_amaliat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cPHcontentHeader" runat="Server">
    ...
    </span><span>&nbsp</span><span id="contentHeader">کدهای غیرعملیاتی</span>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cPHBottomContent" runat="Server">
    <span>
        <asp:LinkButton ID="addCode" CssClass="lnkMenuSideBar" runat="server" OnClick="addCode_Click">افزودن کد غیرعملیاتی جدید</asp:LinkButton>
    </span>
    <hr />
    <span>
    ...
    <hr />
    <span>
        <asp:LinkButton ID="lnkViewAll" CssClass="lnkMenuSideBar" runat="server" OnClick="lnkViewAll_Click">لیست کدهای غیرعملیاتی</asp:LinkButton>
    </span>
    <hr />
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cPHLegendName" runat="Server">
    <asp:Label ID="lblLegenName" runat="server" Text="افزودن کد غیر عملیاتی جدید"></asp:Label>
</asp:Content>
        ...
        <asp:View ID="View2" runat="server">
            <div class="tbl">
                <table style="width: 100%;">
                    <tr>
                        <td>
                            نوع عملیات &nbsp;<span><b style="color: Red;">&nbsp*</b></span>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlIndirectTypes" CssClass="dayDdl" runat="server">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                ...
                <asp:LinkButton ID="lnkView" CssClass="lnk" runat="server" 
                    onclick="lnkView_Click">مشاهده لیست کدهای غیر عملیاتی</asp:LinkButton>
            </div>
        </asp:View>
        <asp:View ID="View1" runat="server">
            <div class="grid">
                ...
                <asp:GridView ID="gvInDirectCode" runat="server" Width="100%" EmptyDataText="هیج رکوردی یافت نشد ..."
                    AutoGenerateColumns="False" DataKeyNames="IdcId"  GridLines="none"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText=" شرح عملیات" DataField="IdcName" ItemStyle-Width="35%">
                            <ItemStyle Width="35%" />
                        </asp:BoundField>
                        <asp:BoundField HeaderText="کد عملیات" DataField="IdcId" ItemStyle-CssClass="itemStyleNumber"
                            ItemStyle-Width="15%">
                            <ItemStyle CssClass="itemStyleNumber" Width="15%" />
                        </asp:BoundField>
                        <asp:BoundField DataField="IdcNote" HeaderText="توضیحات" ItemStyle-Width="25%" />
