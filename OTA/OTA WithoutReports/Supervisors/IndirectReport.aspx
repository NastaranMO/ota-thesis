<%@ Page Title="" Language="C#" MasterPageFile="~/Supervisors/AdminMaster.master" AutoEventWireup="true" CodeFile="IndirectReport.aspx.cs" Inherits="Supervisors_Reports_IndirectReport" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="cPHLegendName" runat="Server">
    <asp:Label ID="lblLegenName" runat="server" Text="گزارش مشروح ورود و خروج کارمندان"></asp:Label>
</asp:Content>
